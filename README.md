...
- [Arch Tools](https://archtools.dev) - 53 production-ready AI tools via MCP with x402 USDC payments on Base L2. Web scraping, crypto market data (CoinGecko), AI text/image generation, OCR, document processing, DNS/WHOIS, URL shortening, and more. MCP SSE endpoint: `https://arch-tools-mcp.onrender.com/sse`. ([GitHub](https://github.com/Deesmo/arch-ai-tools))
